...
class WindMySqlBuilderTest extends BaseTestCase{
	...
	public function testGetSelectSql(){
		...
		$assemblySql = $this->WindMySqlBuilder->from('pw_members','a','username')
	...
	public function testGetInsertSql(){
		...
		$insertSql = $this->WindMySqlBuilder->from('pw_members')
					 ->field('name','age')
	...
	public function testGetUpdateSql(){
		...
		$updateSql = $this->WindMySqlBuilder->from('pw_members')
	...
	public function testGetReplaceSql(){
		...
		$replaceSql = $this->WindMySqlBuilder->from('pw_members')
					 ->field('name','age')
					 ->data(array(array('a','b'),array('c','d')))
					 ->getReplaceSql();
