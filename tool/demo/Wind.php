...
class Wind {
	...
	public static function console($appName = '', $config = array()) {
		if (self::$_frontController === null) {
			Wind::import('WIND:command.WindCommandFrontController');
			self::$_frontController = new WindCommandFrontController($appName, $config);
		}
		return self::$_frontController;
	}
