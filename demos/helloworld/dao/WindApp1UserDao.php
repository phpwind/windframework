...
class WindApp1UserDao extends AbstractWindDao {
	protected $dbConfig = 'DEFAULT:db_config.php';
	protected $cacheConfig = 'DEFAULT:memcache_config.xml';
	protected $cacheClass = 'WIND:component.cache.strategy.WindCacheApc';
	/**
	...
	public function findUserById($userId) {
		$sql = $this->getDbHandler()->getConnection()->getConnection()->getSqlBuilder()->from('pw_members')->field('*')->where('uid = :uid ',array(':uid'=>$userId))->getSelectSql();
		$this->getDbHandler()->getConnection()->getConnection()->query($sql);
		$result =  $this->getDbHandler()->getConnection()->getConnection()->getAllRow();
		print_r($result);
		return $result;
	}

	public function getCacheHandler(){
		$this->cacheHandler->setDbHandler($this->getDbHandler()->getConnection()->getConnection());
	...
	public function getCacheMethods() {
		return array('cache'=>array('findUserById'));
	}
...
/**
	 ...
	 * @return stdClass
	 */
	public function queryForObject($sql, $fetch_type = IWindDbConfig::ASSOC, $colAsProp = true) {
	 ...
	 * @return array
	 */
	public function queryForArray($sql, $fetch_type = IWindDbConfig::ASSOC) {
	 ...
	 * @return array;
	 */
	public function queryBySql($sql, $fetch_type = IWindDbConfig::ASSOC) {
	 ...
	 * @return stdClass
	 */
	public function queryForObjectByBuilder(WindSqlBuilder $builder, $fetch_type = IWindDbConfig::ASSOC, $colAsProp = true) {
	 ...
	 * @return array
	 */
	public function queryForArrayByBuilder(WindSqlBuilder $builder, $fetch_type = IWindDbConfig::ASSOC) {
	 ...
	 * @return array
	 */
	public function queryByBuilder(WindSqlBuilder $builder, $fetch_type = IWindDbConfig::ASSOC) {
	...
	public function getMasterConnection() {
		return $this->connection = $this->getDbHandler()->getConnectionManager()->getMasterConnection();
	}
	...
	public function getSlaveConnection() {
		return $this->connection = $this->getDbHandler()->getConnectionManager()->getSlaveConnection();
	}
