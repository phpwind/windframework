...
<body>
	<div class="wrap">
		<div id="header" class="mb10">
			<div class="header">
				<table width="100%"><tr>
					<td><h2 class="fl logo"><a href="http://t4.pw.com:8080/wind/demos/blog/index.php?m=default&amp;c=index&amp;a=run&amp;"><img src="http://t4.pw.com:8080/wind/demos/blog/static/images/logo.png" width="198" height="80" class="fl" /></a></h2></td>
					<td align="right">
				...
				<div id="navA">
					<div class="navA">
						<ul class="cc">
							<li class="current"><a href="http://t4.pw.com:8080/wind/demos/blog/index.php?m=default&amp;c=index&amp;a=run&amp;">首页</a></li>
							<li><a href="http://t4.pw.com:8080/wind/demos/blog/index.php?m=default&amp;c=index&amp;a=run&amp;">关于本demo</a></li>
							<li class="tail">&nbsp;</li>
						</ul>
					</div>
				</div>
