 ...
 * @package 
 */
class WRouterManager extends WRouter {
	 ...
	 * @param array $config
	 */
	static function _parserConfig($config) {
	 ...
	 * @return string
	 */
	static private function _getParserPath($key, $config = '') {
		$parser = array(
	 ...
	 * @return WRouteParser
	 */
	static function &createRouterParser($config) {
		$className = '';
		if (!$config['parser']) $config['parser'] = self::$_defaultParser;
