 ...
 * @package
 */
class WHttpRequest extends WRequest {
	...
	public function IsSecureConnection(){
		if(isset($this->_request['IS_SSL'])) return $this->_request['IS_SSL'];
	...
	public function getRequestUri(){
		if(isset($this->_request['REQUEST_URI'])) return $this->_request['REQUEST_URI'];
		$requestUri = '';
	...
	public function getFilePath(){
		if(isset($this->_request['FILEPATH'])) return $this->_request['FILEPATH'];
	...
	public function getFile(){
		if(isset($this->_request['FILE'])) return $this->_request['FILE'];
	...
	public function getRequestUrl(){
		if(isset($this->_request['REQUEST_URL'])) return $this->_request['REQUEST_URL'];
	...
	public function getScript(){
		if(isset($this->_request['SCRIPT'])) return $this->_request['SCRIPT'];
	...
	public function getHost($schema = ''){
		if(isset($this->_request['HOST'])) return $this->_request['HOST'];
	...
	public function getUserHostAddr(){
		if(isset($this->_request['REMODE_ADDR'])) return $this->_request['REMODE_ADDR'];
	...
	public function getUserBrowser($userAgent = null){
		if(isset($this->_request['USER_BROWSER'])) return $this->_request['USER_BROWSER'];
	...
	public function getHeaders(){
		if(isset($this->_request['headers'])) return $this->_request['headers'];
