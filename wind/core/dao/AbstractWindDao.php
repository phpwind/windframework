...
abstract class AbstractWindDao extends WindModule {
	 ...
	 *设置DB操作的config 
	 */
	public function attachConfigToDbHandle() {
		if (null === $this->dbHandler) {
			throw new WindException('The dbHandler is null');
		}
		$config = $this->dbHandler->getConfig()->getConfig();
		$this->dbHandler->setDbConfig($config);
	...
	public function getMasterConnection() {
		return $this->connection = $this->getDbHandler()->getMasterConnection();
	}
	...
	public function getSlaveConnection() {
		return $this->connection = $this->getDbHandler()->getSlaveConnection();
	}
